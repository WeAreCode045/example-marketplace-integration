...
**Production app:** [https://vercel-appwrite.vercel.app/](https://vercel-appwrite.vercel.app/) — use this origin for **Base URL** and **`https://vercel-appwrite.vercel.app/callback`** for **Redirect Login URL** in the Integrations Console.
